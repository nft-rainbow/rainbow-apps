  ...
  return (
    <div className="px-[48px] pt-[42px] flex flex-col justify-start">
      ...
      <div className="mt-[42px] flex flex-row w-fit text-[26px] leading-[34px]">
        <div className="py-[3px] px-[12px] rounded-tl-[20px] rounded-bl-[4px] bg-[#6953EF] text-[#ffffff] text-center align-middle">已领取</div><div className="py-[3px] px-[12px] min-w-[102px] border border-[#6953EF] rounded-tr-[4px] rounded-br-[20px] text-center align-middle text-[#6953EF]">{claimed}</div>
      </div>
      ...
      <div className="flex flex-col items-center">
        ...
        <a href={link} target="_blank" className="mt-[42px] text-[28px] leading-[36px] text-[#6953EF] underline">去 Anyweb 查看&gt;</a>
      </div>
    </div>
  )
}
